function addServiceCard(card) {
    ...
    templateEl.content.querySelector(".services-card__title").textContent = card.title;

    templateEl.content.querySelector(".services-card__description").textContent = card.description;

    templateEl.content.querySelector(".services-card__image").src = card.image;
